...
export const Flowers = () => {
  return (
    <>
      <MotionBox delay={0.2} className="absolute -top-[37rem] -left-[18rem] scale-[1.7] xl:scale-[1.4] md:hidden">
      ...
      <div className="absolute -top-[32rem] -right-[26rem] scale-[1.2] md:-top-[22rem] xl:scale-100 md:-right-[25rem] md:scale-[0.40]">
